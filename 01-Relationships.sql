CREATE TABLE animals (
    ...
    zookeeper_id INTEGER, -- ONE-TO-MANY
    medicine_id INTEGER UNIQUE, --ONE-TO-ONE
...
CREATE TABLE animals_food ( --MANY-TO-MANY table
    id SERIAL PRIMARY KEY,
    animal_id INTEGER,
    food_id INTEGER,
...
VALUES ('Kitty', 'mammal', 'tiger', 14, true, '2012-04-06', 20325, 245, 3422, 1, 1),
